    ...
    <el-card shadow="never" class="search-card">
      <el-form :model="query" inline>
        ...
        <el-form-item label="工序名称">
          <el-input v-model="query.processName" placeholder="工序名称" clearable style="width: 140px" />
        </el-form-item>
    ...
    >
      <template v-if="detailData">
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="任务号">{{ detailData.taskNo }}</el-descriptions-item>
          ...
          <el-descriptions-item label="计划数量">{{ detailData.planQty }}</el-descriptions-item>
          <el-descriptions-item label="完成数量">{{ detailData.completedQty }}</el-descriptions-item>
          <el-descriptions-item label="状态">{{ detailData.status }}</el-descriptions-item>
          <el-descriptions-item label="负责人">{{ detailData.assignedPerson }}</el-descriptions-item>
          <el-descriptions-item label="工作中心">{{ detailData.workCenterName }}</el-descriptions-item>
        </el-descriptions>
      </template>
    </el-drawer>
  </div>
...
import type { ProductionWorkVO } from '@/types/query'
