  ...
  <div class="work-start-check-query">
    <el-card shadow="never" class="search-card">
      <el-form :model="query" inline>
        <el-form-item label="工作编号">
          <el-input v-model="query.workOrderNo" placeholder="工作编号" clearable style="width: 180px" />
        </el-form-item>
    ...
    <el-card shadow="never">
      ...
      <el-table v-loading="loading" :data="tableData" border stripe @row-click="handleRowClick">
        ...
        <el-table-column prop="workOrderNo" label="工作编号" min-width="140" />
    ...
    >
      <template v-if="detailData">
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="工作编号">{{ detailData.workOrderNo }}</el-descriptions-item>
