...
export const menuList: MenuItem[] = [
  ...
  },
  {
    ...
    icon: 'Setting',
    children: [
      { path: '/process/instruction', title: '指示书管理', i18nKey: 'menu.process.instruction' },
      { path: '/process/template', title: '工序模板', i18nKey: 'menu.process.template' },
      { path: '/process/info', title: '工序信息', i18nKey: 'menu.process.info' },
      { path: '/process/work-instruction', title: '指导书管理', i18nKey: 'menu.process.workInstruction' },
      { path: '/process/spray-condition', title: '喷涂条件表', i18nKey: 'menu.process.sprayCondition' },
      { path: '/process/machining-program', title: '机械加工程序表', i18nKey: 'menu.process.machiningProgram' },
